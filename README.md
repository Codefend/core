...
3. Once your source code is obfuscated `in folder: /codefend-output` you can then build the obfuscated version of your code and deploy it instead of building and deploying the original unobfuscated files
